...
export async function saveCourse(formData: FormData) {
  ...
  const slug = normalizeRequiredText(formData.get('slug'));
  ...
  revalidatePath('/area');
  redirect(`/admin/${slug}?salvo=curso`);
}
...
export async function saveModule(formData: FormData) {
  ...
  redirect(`/admin/${courseSlug || ''}?salvo=modulo`);
}
...
export async function saveLesson(formData: FormData) {
  ...
  revalidatePath('/admin');
  revalidatePath('/area/evs');
  redirect(`/admin/${courseSlug || ''}?salvo=aula`);
}
...
export async function saveMaterial(formData: FormData) {
  ...
  revalidatePath('/admin');
  revalidatePath('/area/evs');
  redirect(`/admin/${courseSlug || ''}?salvo=material`);
}
